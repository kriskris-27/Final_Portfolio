...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-[3rem] w-full items-center justify-center bg-black dark:bg-black",
        containerClassName,
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-zinc-600 to-zinc-800
`,
        className,
      )}
    >
