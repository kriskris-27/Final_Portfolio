...
import { Home, User, Hammer, Code2, Phone } from "lucide-react";
  ...
  return (
    <>
      <section id="home" className="relative w-full min-h-screen overflow-hidden">
        {/* Spline background with Suspense fallback */}
        <div className="absolute inset-0 z-10">
          <Suspense fallback={<div className="w-full h-full bg-black" />}>
            <LazySpline scene="https://prod.spline.design/MBa6cURPsd720o3y/scene.splinecode" />
          </Suspense>
        </div>

        <div className="absolute inset-x-0 bottom-80 z-0 flex flex-col items-center text-white text-center">
          <h1 className="text-3xl md:text-5xl font-bold drop-shadow-lg pb-14">
            Hey, I’m Kris
          </h1>
